...
const string & get_animal_name2 (const Animal & a){
    return a.name();
}
...
int main( int argc, char ** argv ) {
    ...
    cout<<"the dog is named "<<get_animal_name(d)<<"(using friend function)"<<endl;
    cout<<"the dog is named  "<<get_animal_name2(d)<<"(using non friend function)"<<endl;
}
